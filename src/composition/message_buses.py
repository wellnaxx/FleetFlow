...
def build_command_bus(
    ...
    bus.register(
        ...
        EventDrainingExecutor(
            delegate=route_cases.assign_truck,
            event_collector=event_collector,
        ),
    )
...
def build_query_bus(
    ...
    bus.register(
        VIEW_ALL_CUSTOMERS,
        EventDrainingExecutor(
            delegate=customer_cases.view_all,
            event_collector=event_collector,
        ),
    )
    ...
    bus.register(
        ...
        EventDrainingExecutor(
            delegate=package_cases.view_unassigned,
            event_collector=event_collector,
        ),
    )
    ...
    bus.register(
        ...
        EventDrainingExecutor(
            delegate=route_cases.find_suitable_trucks,
            event_collector=event_collector,
        ),
    )
    bus.register(

...
class CreateRoute_Should(unittest.TestCase):
    ...
    @patch("adapters.driving.cli.commands.create_route.parse_departure_from_tail")
    @patch("adapters.driving.cli.commands.create_route.validate_params_count")
    ...
    def test_param_count_error_bubbles_and_stops(self, mock_parse: MagicMock) -> None:
        ...
        with (
            patch(
                "adapters.driving.cli.commands.create_route.validate_params_count",

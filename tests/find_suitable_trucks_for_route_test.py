...
class FindSuitableTrucksForRoute_Tests(unittest.TestCase):
    ...
    def test_validate_params_exact_called_with_one(self) -> None:
        ...
        with (
            patch("src.adapters.driving.cli.commands.find_suitable_trucks_for_route.validate_params_exact") as mock_validate,
            patch("src.adapters.driving.cli.commands.find_suitable_trucks_for_route.try_parse_int", return_value=123),

"""Package-created outbox payload serialization and validation contracts."""
...
from src.application.eventing.outbox.codecs.packages import PackageCreatedEventPayloadCodec
